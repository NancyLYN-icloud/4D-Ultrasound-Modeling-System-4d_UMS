            ...
            rows.append(
                {
                    ...
                    "monitor_relpath": f"benchmark/instances/{split}/{group_name}/{pointcloud.stem}/monitor_stream.npz",
                    "legacy_sim_monitor_relpath": f"simuilate_data/instances/{split}/{group_name}/{pointcloud.stem}/monitor_stream.npz",
