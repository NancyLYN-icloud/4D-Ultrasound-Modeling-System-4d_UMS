...
def main() -> None:
    ...
    parser.add_argument("--grid-resolution", type=int, default=144)
    parser.add_argument("--base-smooth-iterations", type=int, default=30)
    parser.add_argument("--centerline-samples", type=int, default=31)
    parser.add_argument("--body-contraction", type=float, default=0.18)
    parser.add_argument("--pylorus-contraction", type=float, default=0.30)
    parser.add_argument("--wave-width", type=float, default=0.09)
    parser.add_argument("--wave-start-u", type=float, default=0.32)
    parser.add_argument("--wave-end-u", type=float, default=0.98)
    parser.add_argument("--deformation-smooth-iterations", type=int, default=11)
    parser.add_argument("--deformation-smooth-relax", type=float, default=0.46)
    parser.add_argument("--post-smooth-iterations", type=int, default=14)
    parser.add_argument("--post-smooth-neighborhood-order", type=int, default=8)
    ...
    for record in records:
        generate_phase_models_for_instance(
            ...
            monitor_stream=monitor_path or record.resolved_phase_monitor_stream,
