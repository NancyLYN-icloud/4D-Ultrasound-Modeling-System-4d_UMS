...
run_method() {
    ...
    echo "[Screen] Running: $method ($run_name)"
...
run_method "动态共享-连续形变场" "continuous-history-lite-screen" \
...
run_method "动态共享-连续形变场" "continuous-history-delayed-screen" \
    --dynamic-mesh-resolution 72 \
    --max-points-per-phase 3000 \
    --bootstrap-offset-weight 0.12 \
    --bootstrap-decay-fraction 0.30 \
...
run_method "动态共享-连续形变场" "continuous-soft-regularization-screen" \
    --dynamic-mesh-resolution 72 \
    --max-points-per-phase 3000 \
    ...
    --temporal-acceleration-weight 0.01 \
    --phase-consistency-weight 0.01 \
    --correspondence-temporal-weight 0.0075 \
    --correspondence-acceleration-weight 0.003 \
    --correspondence-phase-consistency-weight 0.003 \
    --correspondence-start-fraction 0.45 \
    --correspondence-ramp-fraction 0.25 \
    --periodicity-weight 0.02 \
    --deformation-weight 0.002 \
...
run_method "动态共享-解耦运动潜码" "decoupled-motion-balanced-screen" \
    --dynamic-mesh-resolution 72 \
    --max-points-per-phase 3000 \
    --confidence-floor 1.0 \
    --temporal-weight 0.02 \
...
run_method "动态共享-解耦运动潜码" "decoupled-motion-delayed-screen" \
    --dynamic-mesh-resolution 72 \
    --max-points-per-phase 3000 \
    --confidence-floor 1.0 \
    --temporal-weight 0.02 \
...
run_method "动态共享-解耦运动潜码" "decoupled-motion-soft-bootstrap-screen" \
    --dynamic-mesh-resolution 72 \
    --max-points-per-phase 3000 \
    --confidence-floor 1.0 \
    --temporal-weight 0.02 \
