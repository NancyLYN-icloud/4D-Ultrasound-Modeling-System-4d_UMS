...
class DynamicModelConfig:
    ...
    global_motion_basis_rank: int = 4
    train_steps: int = 120
    learning_rate: float = 0.001
    surface_batch_size: int = 1024
    eikonal_batch_size: int = 1024
    ...
    correspondence_global_only: bool = False
    correspondence_bootstrap_gate: bool = False
    correspondence_bootstrap_gate_strength: float = 2.0
    ...
    shape_latent_dim: int = 64
    shape_code_reg_weight: float = 1e-4
    shape_offset_reg_weight: float = 0.02
    shape_spatial_weight: float = 0.05
    motion_latent_dim: int = 64
    motion_code_reg_weight: float = 1e-4
    motion_lipschitz_weight: float = 0.02
    motion_mean_weight: float = 0.05
    motion_lipschitz_k: float = 0.6
    ...
    observation_support_radius_mm: float = 6.0
    unsupported_anchor_weight: float = 0.05
    unsupported_laplacian_weight: float = 0.12
    bootstrap_offset_weight: float = 0.25
    bootstrap_decay_fraction: float = 0.35
    bootstrap_teacher_weight: float = 0.0
    bootstrap_teacher_global_only: bool = False
    bootstrap_teacher_support_aware: bool = False
    bootstrap_teacher_support_power: float = 1.0
    bootstrap_teacher_support_floor: float = 0.0
    bootstrap_teacher_pred_to_target_weight: float = 1.0
    bootstrap_teacher_target_to_pred_weight: float = 1.0
    bootstrap_teacher_start_fraction: float = 0.0
    bootstrap_teacher_ramp_fraction: float = 0.0
    basis_coefficient_bootstrap_weight: float = 0.05
    basis_temporal_weight: float = 0.02
    basis_acceleration_weight: float = 0.01
    basis_periodicity_weight: float = 0.02
    residual_mean_weight: float = 0.02
    residual_basis_projection_weight: float = 0.02
    residual_basis_projection_support_aware: bool = False
    residual_locality_weight: float = 0.0
    residual_locality_budget_scale: float = 1.5
    ...
    unsupported_propagation_iterations: int = 0
    unsupported_propagation_neighbor_weight: float = 0.8
